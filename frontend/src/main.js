...
pluralCaseList.push( {plural: "visualizes/visualizes", pascal: "VisualizeVisualize"} )

pluralCaseList.push( {plural: "data/trainData", pascal: "DataTrainData"} )
pluralCaseList.push( {plural: "data/riskData", pascal: "DataRiskData"} )
